...
from functions import getDC, to16
...
class Window:
    def __init__(self, image, root_path='', filename='result.jpeg'):
        self.save_path = root_path + '\\static\\' + filename
    ...
    def draw_rectangles(self, clasters):
        ...
        draw.rectangle((0, a * y[self.k - 1], b - 1, a - 1), fill=get_color(centroids[self.k - 1]),
                       outline=(255, 255, 255))
